    ...
    context 'when is valid an create a idea' do
      it 'should create a theory' do
        ...
        should_not eq('Theory.count') do
          post :create, theory: {title: @ntheory.title, description: @ntheory.description, justification: @ntheory.justification, brief: @ntheory.brief, outlay: @ntheory.outlay, choice: @ntheory.choice,kind: @ntheory.kind, user_id: @ntheory.user_id, view: @ntheory.view}
        end
        response.should be_success
      end
    end
